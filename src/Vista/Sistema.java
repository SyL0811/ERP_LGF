...
public final class Sistema extends javax.swing.JFrame {
    ...
    public Sistema(login priv) {
        initComponents();
        ImageIcon img = new ImageIcon(getClass().getResource("/Img/mesa.png"));
    ...
    private void initComponents() {
        ...
        jLabel38.setText("Restaurante La Gorda Flaca");
        jLabel38.setFocusable(false);
        jLabel38.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        getContentPane().add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 0, 990, 90));
